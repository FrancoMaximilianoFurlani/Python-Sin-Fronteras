...
1 , 'Franco', 'Furlani', 34, 3512308383, 'Espora 519', '1990-01-27', 300000.60, 'Si');

insert into Empleados values ( 
2 , 'Juan', 'Lopez', 20, 3512308393, 'Espora 300', '1990-02-27', 200000.90, 'No');
...
drop table empleados;
 ...
 insert into empleados values (9, 'Jorge', 'García', 33, 2223334445, 'Calle 901', '1977-12-27', 3400.00, 'SI');
  ...
  select * from Empleados where apellido= 'Vargas' ;
...
update Empleados set telefono = 8888888888 where id = 3;
select * from empleados where id=3;


update Empleados set activo = "NO" where ID in ( 1, 2, 3, 4,);
